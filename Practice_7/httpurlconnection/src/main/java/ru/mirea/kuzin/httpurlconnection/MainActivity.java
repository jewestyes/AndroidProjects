package ru.mirea.kuzin.httpurlconnection;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        if(networkInfo!=null && networkInfo.isConnected()){
            String url = "https://ip-api.com/";
            new  DownloadPageTask().execute("http://ip-api.com/json/136.169.221.41"); // запускаем в новом потоке
        }else {
